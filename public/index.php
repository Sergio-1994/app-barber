...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="css/styles.css?t=1632575248708"><script src="https://kit.fontawesome.com/fcc2559b13.js" crossorigin="anonymous"></script>
    <title>web</title>
  </head>
  <body> 
    ...
    <main class="main"> 
      ...
      <div class="gallery" id="gallery">
        <div class="gallery__item"><img src="assets/images/gallery/1.jpg" alt="Imagen de galeria 1"></div>
        <div class="gallery__item"><img src="assets/images/gallery/2.jpg" alt="Imagen de galeria 1"></div>
        <div class="gallery__item"><img src="assets/images/gallery/3.jpg" alt="Imagen de galeria 1"></div>
        <div class="gallery__item"><img src="assets/images/gallery/4.jpg" alt="Imagen de galeria 1"></div>
        <div class="gallery__item"><img src="assets/images/gallery/5.jpg" alt="Imagen de galeria 1"></div>
      </div>
    </main>
    ...
    <script src="js/macy.js?t=1632575248708"> </script>
    <script src="js/scripts-min.js?t=1632575248708"> </script>
  </body>
</html>